...
TOP_LEVEL_NAME="ram_up.ram_up"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/diefre/intelFPGA_pro/19.4/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [ram_up::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [ram_up::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/ncsim_files.tcl
set libraries [dict merge $libraries [ram_up::get_design_libraries]]
...
source $QSYS_SIMDIR/common/ncsim_files.tcl
set design_files [dict merge $design_files [ram_up::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/ncsim_files.tcl
set files [concat $files [ram_up::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
